...
from .config import config, get_redis_config
...
class Master(object):
    ...
    def log(self, infohash, address=None):
        redis_instance.sadd(config['infohash_key'], infohash.encode('hex'))
        # print "%s from %s:%s" % (
...
if __name__ == "__main__":
    ...
    dht = DHTServer(Master(), "0.0.0.0", port, max_node_qsize=200)
    dht.start()
